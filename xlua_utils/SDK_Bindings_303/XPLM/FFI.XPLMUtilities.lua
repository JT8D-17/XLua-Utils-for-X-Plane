function FFI_Init_XPLMUtilities()
ffi.cdef([[
/*
 ...
 *
 */
const char *         XPLMGetVirtualKeyDescription(
                                   char                 inVirtualKey);    
...
print("FFI XPLM: Loaded XPLMUtilities cdefs")
end
