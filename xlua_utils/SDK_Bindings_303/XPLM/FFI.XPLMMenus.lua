--[[ REQUIRES FFI.XPLMDefs.lua and FFI.XPLMUtilities.lua ]]
function FFI_Init_XPLMMenus()
ffi.cdef([[
        /*
        ...
        *
        */
        int                  XPLMAppendMenuItemWithCommand(
                                        XPLMMenuID           inMenu,    
                                        const char *         inItemName,    
        ...
        *
        */
        void                 XPLMRemoveMenuItem(
                                        XPLMMenuID           inMenu,    
                                        int                  inIndex);     
    ]])
print("FFI XPLM: Loaded XPLMMenus cdefs")
end
