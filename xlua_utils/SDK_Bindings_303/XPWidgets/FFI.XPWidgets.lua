 ...
 *
 */
XPLMWindowID XPGetWidgetUnderlyingWindow(
                         XPWidgetID           inWidget);    
...
print("FFI XPWidgets: Loaded XPWidgets cdefs")
end
